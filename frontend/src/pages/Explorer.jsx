...
export default function Explorer(){
    ...
    async function handleSend(e){
        ...
        try{
            ...
            // Acepta tanto al inicio (^) como en cualquier parte si la frase es corta
            const childFriendlyRequests = /(^|\b)(aver|a ver|ver|mira|muestra|mu[eé]strame|mostrar|ense[ñn]a|ense[ñn]ame|dame|pasame|pasa|quiero ver|puedo ver|me das|me ense[ñn]as|me muestras|muestras|hazme|h[aá]zmelo|uno|una|ese|esa|eso|este|esta|esto|ponme|hazlo|sacalo|s[aá]calo)(\s|$|\.|!|,)/i
            ...
            const wantsImage = 
                ...
                (childFriendlyRequests.test(text) && hasRecentAnimalContext && text.length < 80) // "me muestras", "aver" (si habló de animal)
